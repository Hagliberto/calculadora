...
def desenhar_quadro():
    """Adiciona um quadro para rabiscar no Streamlit com opções de desenho e seletor de cor."""
    ...
    # Criar o canvas com configurações personalizadas
    canvas_result = st_canvas(
        fill_color="rgba(255, 255, 255, 0)",  # Fundo transparente
        stroke_width=2.5,  # Espessura do traço
